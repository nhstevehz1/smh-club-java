...
public class PhoneServiceTests extends ServiceTests {
    ...
    @Test
    public void getPhoneListPage_with_empty_sort_uses_default() {
        // setup
        var pageNumber = 10;
        var pageSize = 20;
        var direction = "ASC";
    ...
    @Test
    public void getPhoneListPage_unknown_sortColumn_uses_default() {
        // setup
        var pageNumber = 10;
        var pageSize = 20;
        var direction = "ASC";
    ...
    @Test
    public void getPhoneListPage_with_descending() {
        // setup
        var pageNumber = 10;
        var pageSize = 20;
        var direction = "desc";
    ...
    @Test
    public void getPhoneListPage_returns_pagedModel() {
        // setup
        var pageNumber = 10;
        var pageSize = 20;
        var direction = "desc";
