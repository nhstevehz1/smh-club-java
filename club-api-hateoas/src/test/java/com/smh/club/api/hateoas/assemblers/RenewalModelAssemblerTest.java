...
public class RenewalModelAssemblerTest extends AssemblerTests {

    private RenewalAssemblerImpl assembler;
    ...
    public void model_contains_links() {
        ...
        assertTrue(link.get().getHref().endsWith("/api/v2/renewals/" + entity.getId()));
    ...
    public void model_matches_entity() {
        ...
        assertEquals(entity.getRenewalDate(), model.getRenewalDate());
        assertEquals(entity.getRenewalYear(), model.getRenewalYear());
    }
    ...
    public void from_page_to_pageModel () {
        ...
        // verify
        assertInstanceOf(RenewalModel.class, ret.getContent().stream().toList().get(0));
    }
}
