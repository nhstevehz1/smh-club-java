...
public class MemberMapperTests {
    ...
    public void from_create_to_entity() {
        // setup
        var member = Instancio.create(MemberCreateDto.class);
    ...
    public void from_entity_to_dto() {
        ...
        // execute
        var member = mapper.toMemberDetailDto(entity);
        ...
        assertEquals(entity.getAddresses().size(), member.getAddresses().size());
        assertEquals(entity.getEmails().size(), member.getEmails().size());
        assertEquals(entity.getPhones().size(), member.getPhones().size());
        assertEquals(entity.getRenewals().size(), member.getRenewals().size());
    }
    ...
    public void update_entity_from_updateDto() {
        ...
        // execute
        var updatedEntity = mapper.updateMemberEntity(update, entity);
    ...
    public void from_entityList_to_dtoList(int size) {
        ...
        // execute
        var memberList = mapper.toMemberDtoList(entityList);
    ...
    public void from_entityLit_to_detailList_phones_match() {
        ...
        for (var detailPhone : detail.getPhones()) {
            ...
            assertEquals(entityPhone.getPhoneNum(), detailPhone.getPhoneNum());
